...
public class ContactsDB {
    ...
    private final String DATABASE_NAME = "Contacts_08";
    ...
    private class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            /**
             * Create table contacts table {_id integer primary key autoincrements,
             * _Person name text not null, _cell text not null};
             */

            String sqlCode = "CREATE TABLE " + DATABASE_TABLE + " (" + KEY_ROWID +
                    " INTEGER PRIMARY KEY AUTOINCREMENT, " + KEY_NAME +
                    " TEXT NOT NULL, " + KEY_CELL + " TEXT NOT NULL);";
            db.execSQL(sqlCode);

...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setting up componets for app screen
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //first test if any fields are empty, then send message to user
                ...
                etPassword.getText().toString().isEmpty() || etReEnter.getText().toString().isEmpty()) {
                    ...
                    //if passwords are the same then we register a new user, otherwise notify the user
                    ...
                    if (etPassword.getText().toString().equals(etReEnter.getText().toString())){
                        ...
                        Backendless.UserService.register(user, new AsyncCallback<BackendlessUser>() {
                            ...
                            public void handleResponse(BackendlessUser response) {
                                ...
                                showProgress(false);
                                Toast.makeText(Register.this, "User succesfully registered",
                        ...
                        Toast.makeText(Register.this, "Please make sure your password and retype passowrd are the same!",
                                Toast.LENGTH_SHORT).show();
